...
export class LocationSharedByUserResponseDto {
    @ApiProperty({
        description: "User id",
...
export class LocationResponseDto {
    ...
    @ApiPropertyOptional({
        ...
        type: () => LocationSharedByUserResponseDto
    })
    sharedByUser?: LocationSharedByUserResponseDto;
}

export class LocationSearchResultResponseDto {
    @ApiProperty({
    ...
    @ApiProperty({
        description: "Detected location type",
        enum: LocationType,
    ...
    @ApiProperty({
        description: "Alias of locationType for client compatibility",
        enum: LocationType,
        example: LocationType.CAFE
    })
    type: LocationType;
