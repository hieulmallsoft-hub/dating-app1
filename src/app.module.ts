...
import { BillingModule } from "./modules/common-user/billing/billing.module";
import { SyncRequestsModule } from "./modules/couple-features/sync-requests/sync-requests.module";
@Module({
    imports: [
        ConfigModule.forRoot({
            isGlobal: true,
            envFilePath: ["./.env", "src/env/.env"],
            load: [databaseConfig, jwtConfig, appConfig, authConfig, billingConfig]
        }),
