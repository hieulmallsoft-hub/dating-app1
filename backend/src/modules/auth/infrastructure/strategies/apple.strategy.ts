...
export class AppleStrategy extends PassportStrategy(Strategy, "apple") {
    constructor(private configService: ConfigService) {
        super({
            ...
            privateKeyLocation: configService.get<string>("auth.apple.keyFilePath") || "path/to/key.p8",
            callbackURL:
                configService.get<string>("auth.apple.callbackUrl") || "http://localhost:3000/auth/apple/callback",
            scope: ["email", "name"]
        });
    }
